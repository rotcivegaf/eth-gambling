...
const TestDontHaveOnERC721Received = artifacts.require('./utils/test/ERC721Base/TestDontHaveOnERC721Received.sol');
const Helper = require('./Helper.js');
const TestURIProvider = artifacts.require('./utils/test/ERC721Base/TestURIProvider.sol');
...
contract('ERC721 Base', function (accounts) {
    ...
    it('Test can\'t receive safe transfer', async function () {
        ...
        const receiver = await TestDontHaveOnERC721Received.new();
